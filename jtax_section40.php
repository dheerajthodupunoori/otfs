...
<h3>Summary of Incomes under section 40</h3>
<br>
<h4>Would you like to add Section 40 entries?</h4>
<br>
...
<button type="button" class="btn btn-primary btn-md rental">
  <a href="Jtax_add_section40.php" class="none">
