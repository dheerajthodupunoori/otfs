...
<html lang="en">
<head>
  <title>JTax Non Salary TDS page</title>
  <meta charset="utf-8">
...
<h3 class="h3one">Add a TDS entry (Tax Deducted at Source)</h3>
<br>
<h4 class="h3one">Tax Deducted At Source</h4>
<p class="text-info text-info1">Provide this information from TDS certificate provided by deductor</p>
<br>
...
<form action="" method="post" class="form">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputEmail4" placeholder="" name="tan" required />
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Name of Deductor *</label>
      <input type="password" class="form-control" id="inputPassword4" placeholder="" name="nod"required />
    </div>
  </div>
 ...
 <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="number" class="form-control" id="inputEmail4" placeholder="" name="tdsd" required/>
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Total Tax Deducted *</label>
	  
      <input type="number" class="form-control" id="inputPassword4" placeholder="" name="ttd" required/>
    </div>
  </div>
  ...
  <div class="form-group col-md-12">
    <label for="inputAddress2">TDS Certificate Number</label>
	<p class="bg-info">This field is optional. Leave blank if you do not know the TDS Certificate Number.</p>
    <input type="text" class="form-control" id="inputAddress2" placeholder=""  name="cn"/>
  </div>
  </div>
