...
<html lang="en">
<head>
  <title>JTax Add Rental page</title>
  <meta charset="utf-8">
...
<br>
<br>
<h3 class="h3one"><b>Income earned from Rental Property</b></h3>
<br></br>
</br>
<p class="text-info">If you <b>own a house </b>and are <b>earning rent on it</b> then specify the income here.

If you are paying rent to someone else, you should not enter the amount in this section.</p>
<br></br>
  <button type="button" class="btn btn-primary btn-md rental">
  <a href="Jtaxrental.php" class="none">
  Add Rental Property Details</a></button>
  <br></br>
  </br>
  <p class="info">Go to next if you do not have any rental properties.</p>
  <br>

  <button type="button" class="btn btn-default next">
  <a href="Jtaxcapitalgain.php" class="none"> 
 Next</a></button>
  <br></br>
  <hr class="bottom">
