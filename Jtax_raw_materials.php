...
<html lang="en">
<head>
  <title>JTax Raw Materials page</title>
  <meta charset="utf-8">
...
<h3>Add Manufacture Raw Materials</h3>
...
$('#firm_indirectowners_btn').click(function()
{
   ...
   var ele="<div class='panel panel-default' id='pnlfio"+firm_indirectowners_cntr+"'><div class='panel-body' style='max-height:340px;'><div style='margin:20px;position: relative;left: 10px;top: -43px; margin-top:61px;'>ID<input type='number_format' id='fioiln"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;' name='id'/></div><div style='margin:20px; position: relative;left: 300px;top: -85px;'>Name<input type='text' id='fioit"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1; name='name'/></div><div style='margin:20px; position: relative;left: 620px;top: -135px;'>Unit<input type='number' name='unit' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 6px;top: -126px;'>Opening<input type='number' name='opening' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 370px;top: -172px;'>Sales<input type='number' name='sales' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 6px;top: -163px;'>Purchase<input type='number' name='purchase' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 369px;top: -209px;'>Closing<input type='number' name='closing' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 703px;top: -289px;'>Shortage/Excess<input type='number' name='excess' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left:6px;top: -239px;'>Consumption<input type='number' name='consumption' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 370px;top: -284px;'>Yield<input type='number' name='yield' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 706px;top: -333px;'>Per<input type='number' name='per' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div></div><div class='panel-footer'><button class='btn btn-danger' type='button' onclick='fiood("+firm_indirectowners_cntr+")'>delete</button></div></div>";
