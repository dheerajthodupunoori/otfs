...
<html lang="en">
<head>
  <title>JTax Immovable Property Outside India page</title>
  <meta charset="utf-8">
...
<h3>Schedule FA: Details of Immovable Foreign Assets</h3>
<br>
<p class="text-info"><b>Instructions:</b> The Total Investment has to be filled-up as investment at cost in immovable property held during the year, converted to Indian Rupees.</p>
...
$('#firm_indirectowners_btn').click(function()
{
   ...
   var ele="<div class='panel panel-default' id='pnlfio"+firm_indirectowners_cntr+"'><div class='panel-body' style='max-height:340px;'><div style='margin:20px;position: relative;left: 10px;top: -43px; margin-top:61px;'>ID<input type='number_format' id='fioiln"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;' name='id'/></div><div style='margin:20px; position: relative;left: 300px;top: -85px;'>Country<input type='text' id='fioit"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1; name='country'/></div><div style='margin:20px; position: relative;left: 620px;top: -135px;'>Address Of Property<input type='text' name='aop' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 6px;top: -126px;'>Type Of Owner<input type='text' name='too' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 370px;top: -172px;'>Date Of Acquisition<input type='text' name='doa' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 6px;top: -163px;'>Income Derived From Property<input type='number' name='idp' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 422px;top: -209px;'>Nature Of Income<input type='text' name='noi' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 703px;top: -289px;'>Total Investment<input type='number' name='ti' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div></div><div class='panel-footer'><button class='btn btn-danger' type='button' onclick='fiood("+firm_indirectowners_cntr+")'>delete</button></div></div>";
