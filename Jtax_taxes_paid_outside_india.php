...
<html lang="en">
<head>
  <title>JTax Taxes Paid Outside india  page</title>
  <meta charset="utf-8">
...
<div class="div1">
<h3>Schedule TR: Details of Taxes Paid outside India</h3>
<br>
<h4>Refund Received in Foreign Country</h4>
<br>
<p class="bg-info">Mention any amount that was claimed as Tax Relief in India in previous years and has been received as 'refund' during this assessment year.</p>
<br>
...
<div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="number" class="form-control" id="inputEmail4" placeholder="" name="rar" required />
    </div>
    <div class="form-group col-md-6">
      <label for="inputPassword4">Assessment Year for which claimed as Tax Relief * 
</label>
      <select name="ay">
...
<a href="Jtaxtaxfilingassets.php">Go Back</a>
