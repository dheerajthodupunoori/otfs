...
<html lang="en">
<head>
  <title>JTax Trading Concern page</title>
  <meta charset="utf-8">
...
<h3>Add Trading Company Details</h3>
...
$('#firm_indirectowners_btn').click(function()
{
   ...
   var ele="<div class='panel panel-default' id='pnlfio"+firm_indirectowners_cntr+"'><div class='panel-body' style='max-height:340px;'><div style='margin:20px;position: relative;left: -1px;top: -43px; margin-top:61px;'>ID<input type='number_format' id='fioiln"+firm_indirectowners_cntr+"' style='position:relative;left:38px;' onkeydown='firm_indirectowners=1;' name='id'/></div><div style='margin:20px; position: relative;left: 414px;top: -85px;'>Name<input type='text' id='fioit"+firm_indirectowners_cntr+"' style='position:relative;left:88px;' onkeydown='firm_indirectowners=1; name='name'/></div><div style='margin:20px; position: relative;left: -4px;top: -64px;'>Unit<input type='number' name='unit' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:75px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: -4px;top: -64px;'>Opening<input type='number' name='opening' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:75px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: -4px;top: -64px;'>Sales<input type='number' name='sales' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:75px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: -4px;top: -64px;'>Purchase<input type='number' name='purchase' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:75px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: -4px;top: -64px;'>Closing<input type='number' name='closing' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:75px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 370px;top: -113px;'>Shortage/Excess<input type='number' name='excess' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:71px;top:-3px;' onkeydown='firm_indirectowners=1;'/></div></div><div class='panel-footer'><button class='btn btn-danger' type='button' onclick='fiood("+firm_indirectowners_cntr+")'>delete</button></div></div>";
