...
<html lang="en">
<head>
  <title>JTax Tax Collected At Source(TCS) page</title>
  <meta charset="utf-8">
...
<h3 class="h3one">Add a TCS entry (Tax Collected at Source)</h3>
<br>
<h4 class="h3one">Tax Collected At Source</h4>
<p class="text-info text-info1">Provide this information from TCS certificate provided by deductor</p>
<br>
<div class="h3one">
...
<div class="form-group">
  <div class="form-group col-md-12">
    <label for="inputAddress2">TAN of Collector *</label>
    <input type="text" class="form-control" id="inputAddress2" placeholder=""  name="tan" required/>
  </div>
</div>
...
<div class="form-group">
  <div class="form-group col-md-12">
    <label for="inputAddress2">Name of Collector *</label>
...
<div class="form-group">
  <div class="form-group col-md-12">
    <label for="inputAddress2">Total Tax Collected *</label>
    <input type="number" class="form-control" id="inputAddress2" placeholder=""  name="ttc" required/>
  </div>
</div>
...
<div class="form-group">
  <div class="form-group col-md-12">
    <label for="inputAddress2">Tax Collected claimed for this year *</label>
	<p class="text-info">Usually this amount is same as Total Tax Collected. </p>
    <input type="number" class="form-control" id="inputAddress2" placeholder=""  name="ttc" required/>
  </div>
</div>
...
<div class="form-group">
  <div class="form-group col-md-12">
    <label for="inputAddress2">Income against which TCS was deducted *</label>

    <input type="number" class="form-control" id="inputAddress2" placeholder=""  name="ia" required/>
  </div>
</div>
 ...
 <div class="form-group">
  <div class="form-group col-md-12">
    <label for="inputAddress2">Financial Year in which TCS was collected </label>
