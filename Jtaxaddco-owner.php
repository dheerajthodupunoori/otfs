...
<html lang="en">
<head>
  <title>JTax Add Co-Owner page</title>
  <meta charset="utf-8">
...
<h3 class="h3one">Specify Co-owners for Self Occupied Property</h3>
<br></br>
<p class="p1">Would you like to add a Co-owner?</p>
<br></br>

<button type="button" class="btn btn-primary rental">
<a href="Jtaxco-owner.php" class="none">
Add a Co-Owner</a></button>



<button type="button" class="btn btn-primary rental">
<a href="Jtaxhouse.php" class="none">
Go back to Properties Page</a></button>
<br>
<hr class="bottom">
