...
<html lang="en">
<head>
  <title>JTax Section 43B page</title>
  <meta charset="utf-8">
...
<h3>Summary of Incomes under section 43B</h3>
<br>
<h4>Would you like to add Section 43B entries?
</h4>
<br>
<p class="text-info"><b>These are the expenses in the previous year but actually paid in this year.</b></p>
<br>

<button type="button" class="btn btn-primary btn-md rental">
  <a href="Jtax_add_section43b.php" class="none">
  Add an Entry</a></button>
  <br>
  <hr class="line">
  <br>
<a href="Jtaxbussiness.php">Go Back to Bussiness And Profession</a>
</div>
