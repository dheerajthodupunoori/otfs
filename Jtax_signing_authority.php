...
$('#firm_indirectowners_btn').click(function()
{
   ...
   var ele="<div class='panel panel-default' id='pnlfio"+firm_indirectowners_cntr+"'><div class='panel-body' style='max-height:340px;'><div style='margin:20px;position: relative;left: 10px;top: -43px; margin-top:61px;'>ID<input type='number_format' id='fioiln"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;' name='id'/></div><div style='margin:20px; position: relative;left: 300px;top: -85px;'>Country<input type='text' id='fioit"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1; name='country'/></div><div style='margin:20px; position: relative;left: 620px;top: -135px;'>Name Of Institution<input type='text' name='noi' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 6px;top: -126px;'>Address Of Institution<input type='text' name='aoi' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 370px;top: -172px;'>Name Mentioned In The Account<input type='text' name='name' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 6px;top: -163px;'>Account Number<input type='number' name='ac' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 422px;top: -209px;'>Peak Balance Or Investement During The Year<input type='number' name='pb' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div><div style='margin:20px; position: relative;left: 703px;top: -289px;'>Is Income Accrued Taxable<input type='text' name='iit' id='fiortd"+firm_indirectowners_cntr+"' style='position:relative;left:10px;' onkeydown='firm_indirectowners=1;'/></div></div><div class='panel-footer'><button class='btn btn-danger' type='button' onclick='fiood("+firm_indirectowners_cntr+")'>delete</button></div></div>";
