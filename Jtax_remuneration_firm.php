...
<html lang="en">
<head>
  <title>JTax Remuneration Firm page</title>
  <meta charset="utf-8">
...
<h3>Remuneration received From Partnership Firm</h3>
<h4 class="text-info">If you are a Partner at a Firm, specify your remuneration.</h4>

<button type="button" class="btn btn-default save">
<a href="Jtaxbussiness.php" class="bussiness none">
Go to Next>></a></button>
<br></br>
<button type="button" class="btn btn-primary btn-md rental">
  <a href="Jtax_add_remuneration_firm.php" class="none">
  Add Remuneration from Firm</a></button>
  <br></br>
</div>
<hr class="bottom">
